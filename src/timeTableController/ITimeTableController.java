...
/**
 * Cette classe est l'interface du contr么leur que vous devez implémenter. 
...
public interface ITimeTableController {
	 ...
	 * tableau de cha卯nes de caractères où chaque ligne contient l'identifiant d'un emploi du temps.
	 * 
	 * @return
